    ...
    t.prototype._reset = function() {
        ...
        t.prototype.changeColor = function(t) {
            this.body.attr("data-sidebar-color", t),
                this.parent.updateConfig("sidebar", {
                    color: t
                })
        }
        ,
        ...
        t.prototype.initMenu = function() {
            ...
            this._reset(),
                l(".button-menu-mobile").on("click", function(t) {
                    ...
                    993 <= i.window.width() ? "condensed" === e ? i.changeSize("condensed" === a ? "default" : a) : i.changeSize("condensed") : (i.changeSize(a),
            ...
            if (l("#two-col-sidenav-dashboard").length) {
                var n = l("#two-col-sidenav-dashboard .nav-link")
                ...
                (s = l("#two-col-menu li .collapse")).on({
                    ...
                    n.on("click", function(t) {
                        ...
                        return !e.length || (t.preventDefault(),
                ...
                n.each(function() {
                    ...
                    l("#two-col-menu a").each(function() {
                        if (this.href == d) {
                            ...
                            l("#two-col-sidenav-dashboard .nav-link").each(function() {
        ...
        t.prototype.initLayout = function() {
            if (768 <= this.window.width() && this.window.width() <= 1028 || this.body.data("keep-enlarged"))
                this.changeSize("condensed");
            else {
                var t = JSON.parse(this.body.attr("data-layout") ? this.body.attr("data-layout") : "{}")
                    , e = l.extend({}, t ? t.sidebar : {})
                    , i = e && e.size ? e.size : "default"
                    , a = this.body.attr("data-sidebar-size");
                this.changeSize(i || (a || "default"))
            }
        }
        ,
        ...
        t.prototype.initMenu = function() {
            ...
            t.prototype.changeColor = function(t) {
                this.body.attr("data-topbar-color", t),
                    this.parent.updateConfig("topbar", {
                        color: t
                    })
            }
            ,
    ...
    function(i) {
        ...
        t.prototype.selectOptionsFromConfig = function() {
            ...
            t && (i("input[type=radio][name=color-scheme-mode][value=" + t.mode + "]").prop("checked", !0),
                ...
                i("input[type=radio][name=leftsidebar-size][value=" + t.sidebar.size + "]").prop("checked", !0),
                i("input[type=checkbox][name=leftsidebar-user]").prop("checked", t.sidebar.showuser),
                i("input[type=radio][name=topbar-color][value=" + t.topbar.color + "]").prop("checked", !0))
        }
            ,
    ...
    function(n) {
        ...
        t.prototype._saveConfig = function(t) {
            ...
            t.prototype.applyConfig = function() {
                ...
                var t = n.extend({}, this.config.topbar)
                    , e = n.extend({}, this.config.sidebar);
                this.leftSidebar.init(),
                    ...
                    this.leftSidebar.changeColor(e.color),
                    this.leftSidebar.changeSize(e.size),
                    this.leftSidebar.showUser(e.showuser),
        ...
        t.prototype.initTooltipPlugin = function() {
            ...
            t.prototype.initFormValidation = function() {
                o(".needs-validation").on("submit", function(t) {
                    ...
                    !1 !== o(this)[0].checkValidity() || (t.preventDefault(),
                        t.stopPropagation(),
                        !1)
                })
            }
        ...
        t.prototype.init = function() {
            ...
            n(document).on("click", this.$portletCloser, function(t) {
                ...
                n(document).on("click", this.$portletRefresher, function(t) {
                    t.preventDefault();
                    var e = n(this).closest(a.$portletIdentifier);
                    e.append('<div class="card-disabled"><div class="card-portlets-loader"><div class="spinner-border text-primary m-2" role="status"></div></div></div>');
    ...
    function(e) {
        ...
        t.prototype.initControls = function() {
            ...
            t.prototype.init = function() {
                ...
                window.sessionStorage && t && t.hasOwnProperty("showRightSidebarOnPageLoad") && t.showRightSidebarOnPageLoad && (sessionStorage.getItem("_MINTON_VISITED_") || (e.RightBar.toggleRightSideBar(),
                    sessionStorage.setItem("_MINTON_VISITED_", !0)))
            }
            ,
            e.App = new t,
            e.App.Constructor = t
