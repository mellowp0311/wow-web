            ...
            l("#selectize-tags").selectize({
                ...
                l("#selectize-links").selectize({
                    ...
                    render: {
                        ...
                        item: function(e, t) {
                            return '<div class="item"><a href="' + t(e.url) + '">' + t(e.title) + "</a></div>"
                        }
                    },
                    create: function(e) {
                        return {
                ...
                l("#selectize-programmatic").selectize({
                    ...
                    render: {
                        optgroup_header: function(e, t) {
                            return '<div class="optgroup-header">' + t(e.label) + ' <span class="scientific">(' + t(e.label_scientific) + ")</span></div>"
                        }
                    }
                }),
                ...
                l("#my_multi_select3").multiSelect({
                    ...
                    afterInit: function(e) {
                        var t = this
                            ...
                            , l = "#" + t.$container.attr("id") + " .ms-elem-selectable:not(.ms-selected)"
                        ...
                        t.qs1 = a.quicksearch(l).on("keydown", function(e) {
                            ...
                            t.qs2 = i.quicksearch(o).on("keydown", function(e) {
                                if (40 == e.which)
